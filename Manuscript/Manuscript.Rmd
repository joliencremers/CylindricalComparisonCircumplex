...
consist of a linear and a circular component. @gurtman2011reasoning refers to
...
the teacher data and conduct a 'standard' analysis for these data that we can compare the results from the cylindrical models to.
