...
\newline
\indent The aim in the present paper is twofold. Firstly, we we intend to fill
the above mentioned gap in the literature by showing the use of cylindrical
...
cylindrical variable as outcome components. These adapted circular models are
...
bivariate space.}, where \(A\) represents a score on the Agency dimension and
\(C\) represents a score on the Communion dimension. Note that when placing a
